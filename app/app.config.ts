...
export default defineAppConfig({
	...
	footer: {
		...
		iconNav: [
			...
			{ icon: 'ri:qq-line', text: 'QQ', url: 'tencent://AddContact/?fromId=45&fromSubId=1&subcmd=all&uin=434871910&website=www.qq.com' },
			{ icon: 'tabler:brand-github', text: 'GitHub', url: 'https://github.com/youngdajie' },
	...
	nav: [
		{
			...
			items: [
				...
				{ icon: 'i-ph:user-bold', text: '关于', url: '/about' },
